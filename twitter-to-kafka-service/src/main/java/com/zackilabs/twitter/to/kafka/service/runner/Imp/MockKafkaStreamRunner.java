package com.zackilabs.twitter.to.kafka.service.runner.Imp;


import com.zackilabs.appconfigdata.config.TwitterToKafkaConfigData;
import com.zackilabs.twitter.to.kafka.service.exceptions.TwitterToKafkaServiceException;
import com.zackilabs.twitter.to.kafka.service.listner.TwitterKafkaStatusListener;
...
public class MockKafkaStreamRunner implements StreamRunner {
    ...
    public MockKafkaStreamRunner(TwitterToKafkaConfigData twitterToKafkaConfigData, TwitterKafkaStatusListener twitterKafkaStatusListener) {
    ...
    public void start() throws TwitterException {
        ...
        simulateTwitterStreams(keywords, minTweetLength, maxTweetLength, sleepTimeMs);
    }

    private void simulateTwitterStreams(String[] keywords, int minTweetLength, int maxTweetLength, long sleepTimeMs) throws TwitterException {
