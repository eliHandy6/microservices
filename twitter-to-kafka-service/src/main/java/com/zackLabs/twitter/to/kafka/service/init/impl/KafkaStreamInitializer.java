package com.zackLabs.twitter.to.kafka.service.init.impl;

import com.zackLabs.kafka.admin.client.KafkaAdminClient;
import com.zackLabs.twitter.to.kafka.service.init.StreamInitializer;
...
@Component
@Import({KafkaAdminClient.class, KafkaConfigData.class})
